...
- [Spotify-WP Project](#spotify-wp-project)
  ...
  - [Milestone 3](#milestone-3)
    ...
    - [Mô tả các chức năng milestone 3](#mô-tả-các-chức-năng-milestone-3)
      - [1. **22120157 - Nguyễn Nam Khánh**](#1-22120157---nguyễn-nam-khánh)
      - [2. **22120163 - Phạm Đào Anh Khoa**](#2-22120163---phạm-đào-anh-khoa)
...
1. **Sử dụng công cụ livechart để visualize dữ liệu nghe nhạc.**
2. **Binding keyboard với các command trong ứng dụng (play/pause, next, previous, up volume, down volume)**
